...
class NascarApiClient:
    ...
    def get_live_feed(self, series=Series.CUP):
        """
    ...
    def _parse_live_feed(self, data, series):
        ...
        for idx, vehicle in enumerate(data.get('vehicles', []), 1):
            ...
            car = {
                ...
                'driver': driver_name,
                'interval': None,  # Calculate from data if available
        ...
        # Calculate intervals (if we have timing data)
        # For now, interval will be None - we'd need loop data for this
